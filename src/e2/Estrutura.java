...
//--------------------------------------------------------------
   public void insert(String nome, int idade, String profissao)    // insere o elemento no vetor
      {
      int j;
      for(j=0; j<nElems; j++)        // localiza onde esse elemento se encaixa
          //usamos aqui o metodo compareTo para String
          if (a[j].getNome().compareTo(nome) > 0) //mudado
            break;
      ...
      a[j] = new Pessoa(nome, idade, profissao);                  // insere o elemento na posição necessária
